...
public class PrototypeClient {
	...
	prototype.Resume aResume = new prototype.Resume();
	aResume.setName("大鸟 ").setGender("男 ").setAge(25);
	aResume.setWorkExperience("1999-2002, ", "XX公司");

	prototype.Resume bResume = (prototype.Resume) aResume.clone();
	bResume.setWorkExperience("1999-2002, ", "YY公司");

	prototype.Resume cResume = (prototype.Resume) aResume.clone();
	...
	prototype.Resume bResume = (prototype.Resume) aResume.deepClone();
	bResume.setWorkExperience("1999-2002, ", "YY公司");

	prototype.Resume cResume = (prototype.Resume) aResume.deepClone();
	cResume.setWorkExperience("1999-2002, ", "ZZ公司");
